...
export class ConsumerQuotaLimit extends jspb.Message {
  ...
  clearSupportedLocationsList(): void;
  getSupportedLocationsList(): Array<string>;
  setSupportedLocationsList(value: Array<string>): void;
  addSupportedLocations(value: string, index?: number): string;
...
export namespace ConsumerQuotaLimit {
  export type AsObject = {
    ...
    supportedLocationsList: Array<string>,
  }
}
...
export class QuotaBucket extends jspb.Message {
  ...
  hasProducerQuotaPolicy(): boolean;
  clearProducerQuotaPolicy(): void;
  getProducerQuotaPolicy(): ProducerQuotaPolicy | undefined;
  setProducerQuotaPolicy(value?: ProducerQuotaPolicy): void;
...
export namespace QuotaBucket {
  export type AsObject = {
    ...
    producerQuotaPolicy?: ProducerQuotaPolicy.AsObject,
...
export class ProducerQuotaPolicy extends jspb.Message {
  getName(): string;
  setName(value: string): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ProducerQuotaPolicy.AsObject;
  static toObject(includeInstance: boolean, msg: ProducerQuotaPolicy): ProducerQuotaPolicy.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: ProducerQuotaPolicy, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ProducerQuotaPolicy;
  static deserializeBinaryFromReader(message: ProducerQuotaPolicy, reader: jspb.BinaryReader): ProducerQuotaPolicy;
}

export namespace ProducerQuotaPolicy {
  export type AsObject = {
    name: string,
    policyValue: number,
    dimensionsMap: Array<[string, string]>,
